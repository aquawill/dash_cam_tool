                                        ...
                                        if os.path.isfile(image_file) and str(image_file).split('.')[1] == 'jpg':
                                            def post_process(input_image):
                                                if panorama == 1:
                                                    ...
                                                    exiftool_exec_command = ''
                                                    if platform.system() == 'Windows':
                                                        exiftool_exec_command = 'exiftool.exe'
                                                    else:
                                                        exiftool_exec_command = 'exiftool'
                                                    exiftool_cmd = '{} -ProjectionType="equirectangular" ' \
                                                        ...
                                                        exiftool_exec_command, img_w, img_h, img_w, img_h, input_image)
